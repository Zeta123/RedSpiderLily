...
/*		System.out.println(o.getBookName().toString());
		System.out.println(o.getBookAuthor().toString());
		System.out.println(o.getStorePath().toString());
		System.out.println(o.getMainClassification().toString());
		System.out.println(o.getSubClassification().toString());*/
