...
public class ClassificationBookEditor extends EditorPartAdapter{
	...
	public void createPartControl(Composite parent){
		...
		ClassificationBookEditorActionGroup actionGroup = new ClassificationBookEditorActionGroup(tv);
