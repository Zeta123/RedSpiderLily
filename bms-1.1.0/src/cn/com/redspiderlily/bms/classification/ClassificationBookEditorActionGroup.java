...
import cn.com.redspiderlily.bms.system.ClassificationDialog;
import cn.com.redspiderlily.bms.system.ImagesContext;
import cn.com.redspiderlily.bms.system.SmsFactory;

public class ClassificationBookEditorActionGroup extends ActionGroup{
	...
	private class SearchAction extends Action{
		...
		public void run(){
			...
			ClassificationDialog classificationDialog = new ClassificationDialog(null);
			if(classificationDialog.open() == IDialogConstants.OK_ID){
				String mainClassification = classificationDialog.getMainClassification();
				String subClassification = classificationDialog.getSubClassification();
				tv.setInput(db.getClassifiedBookList(mainClassification,subClassification));
			}
		}
	}
}
