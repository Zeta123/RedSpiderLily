package cn.com.redspiderlily.bms.navigator;
...
import cn.com.redspiderlily.bms.score.SearchView;
import cn.com.redspiderlily.bms.system.LabelProviderAdapter;
import cn.com.redspiderlily.bms.system.SmsFactory;
import cn.com.redspiderlily.bms.system.TreeContentProviderAdapter;
...
public class NavigatorView extends ViewPart{
	...
	private class MyDoubleClickListener implements IDoubleClickListener{
		public void doubleClick(DoubleClickEvent event){
			...
			if(entry.getName().equals("ËÑË÷Êé¼®")){
				try{
