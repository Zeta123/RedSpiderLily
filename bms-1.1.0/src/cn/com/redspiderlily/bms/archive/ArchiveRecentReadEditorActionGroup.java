...
public class ArchiveRecentReadEditorActionGroup extends ActionGroup{
	private TableViewer tv;
	private DbOperate db = SmsFactory.getDbOperate();
	private Action openAction = new OpenAction();	//打开书籍，书架中的方法
	
	public ArchiveRecentReadEditorActionGroup(TableViewer tv){
		this.tv = tv;
	}
	...
	public void fireFirstAction(){
		...
		tv.setInput(db.getRecentReadBook());
	}
}
